...
class MySQLHandler
{
    ...
    private int $vartparam = 0;
    private ?mysqli_stmt $stmt = null;
    private bool $showdebug = DEBUG_MODE;
    ...
    public function ShowQueryDetails()
    {
        ...
        $params = trim($params, ";");
        echo self::FormatSQL($this->querystring) . "<br><br>Paraméterek: " . $params . "<br><br>Query futásideje: " . round($this->queryruntime, 2) . " mp";
    }
        ...
        if($this->showdebug)
        {
            ...
            )
            {
                $message = "<h2>Hibás paraméterszám!</h2>" . "Várt paraméter: " . $this->vartparam . "<br>Típusszám: " . strlen($this->types)
                    . "<br>Paraméterszám: " . count($this->params) . "<br>Lekérdezés:<br>" . self::FormatSQL($this->querystring) . "<br>";
            }
