...
class Helpers
{
    ...
    public static function arrayMultiDimension($array) {
        rsort($array);
        return isset($array[0]) && is_array($array[0]);
    }

    public static function Feltoltes($fajlok, $filetypes, $mediatype, $gyokermappa, $egyedimappa, $csakurl = false) {
        ...
        if(self::ArrayMultiDimension($fajlok))
        {
